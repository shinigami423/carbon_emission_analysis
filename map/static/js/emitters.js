...
//   // This function returns the style data for each of the emitters we plot on
//   // the map. We pass the magnitude of the eimitter into two separate functions
...
//   // This function determines the color of the marker based on the emission.
//   function getColor(carbon_dioxide_emissions) {
//     if (carbon_dioxide_emissions > 1.79e5) {
//     return "#ea2c2c";
//     }
...
//   // Use d3.json to make a call to get our state boundaries geoJSON data.
//   d3.json("https://raw.githubusercontent.com/PublicaMundi/MappingAPI/master/data/geojson/us-states.json").then(function(plateData) {
//     L.geoJson(plateData, {
//       color: "#ff6500",
//       weight: 2
//     }).addTo(allPlates)
